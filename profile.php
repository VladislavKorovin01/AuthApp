<?php
    ...
    // echo "Id: " . GetProfileValue("id") . " Name: " . GetProfileValue("name") . " Email: " . GetProfileValue("email");
?>
...
<div class='border border-primary rounded-3 col-lg-3 col-md-5 col-sm-6 col-6 p-3 ms-3 container'>
    ...
    <div class='from-group mb-3'>
        ...
        <input class='form-control' type='text' name='name' value='<?php echo GetProfileValue("name")?>'/>
        <span class='text-danger'><?php echo GetError("name")?></span>
    </div>
    <div class='from-group mb-3'>
        <label class='form-label'>Phone</label>
        <input class='form-control' type='text' name='phone' value='<?php echo GetProfileValue("phone")?>'/>
        <span class='text-danger'><?php echo GetError("phone")?></span>
    </div>
    <div class='from-group mb-3'>
        <label class='form-label'>Email</label>
        <input class='form-control' type='text' name='email' value='<?php echo GetProfileValue("email")?>'/>
        <span class='text-danger'><?php echo GetError("email")?></span>
    </div>

    <div class='form-group mb-3'>
        <label class="form-label">Password</label>
        <input id='pass' class="form-control" type="password" name='password' value='<?php echo ""?>'/>
    ...
    <div class='form-group mb-3'>
        <label class="form-label">Password</label>
        <input id='pass' class="form-control" type="password" name='passwordConfirm' value=''/>
    </div>
